...
with open("/Users/zrollins/Documents/Documents/tcrai/tcr0001/modeller/numc_interface_TCR_pMHC.xvg") as f:
...
with open("/Users/zrollins/Documents/Documents/tcrai/tcr0001/modeller/numc_interface_CDR3a_pep.xvg") as f:
    #lines = (line for line in f if not line.startsiwith('#') if not line.startswith('$'))
    for line in f:
        if line.startswith('#'):
            continue
...
with open("/Users/zrollins/Documents/Documents/tcrai/tcr0001/modeller/numc_interface_CDR3b_pep.xvg") as f:
    #lines = (line for line in f if not line.startsiwith('#') if not line.startswith('$'))
    for line in f:
        if line.startswith('#'):
            continue
...
ax.set_ylabel('Number of LJ Contacts', fontsize=20)
ax.set_xlabel('Time (ns)', fontsize=20)
ax.set_ylim(0,600)
#ax.set_title('H-Bonds vs Time (DMF5_L1 Equilibration)')
plt.savefig('/Users/zrollins/Documents/Documents/tcrai/tcr0001/modeller/contacts_t_eq.png', bbox_inches='tight',dpi=300)
plt.show()
...
df3= df3.to_frame()
df3['LJ-Contact Frequency (TCR-pMHC)']= df3['Time (ns)']/max_t
df3.to_excel('/Users/zrollins/Documents/Documents/tcrai/tcr0001/modeller/cfrequency.xlsx')
print(df3)